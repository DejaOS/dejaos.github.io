...
module.exports = {
  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        { to: 'docs/welcome', activeBasePath: 'docs', label: 'Guide', position: 'right' },
        { to: 'modules/welcome', activeBasePath: 'modules', label: 'Modules', position: 'right' },
        { to: '/devices', activeBasePath: 'devices', label: 'Devices', position: 'right' },
        { to: '/blog', activeBasePath: 'blog', label: 'Blog', position: 'right' },
        { to: '/showcase', activeBasePath: 'showcase', label: 'Showcase', position: 'right' },
        { type: 'localeDropdown', position: 'right' },
        { href: 'https://www.feocey.com/', label: 'FEOCEY', position: 'right' },
        { href: 'https://github.com/DejaOS/DejaOS', position: 'right', className: 'header-github-link', 'aria-label': 'GitHub repository' },
        { href: 'https://www.youtube.com/@dxdop_iot', position: 'right', className: 'header-youtube-link', 'aria-label': 'YouTube channel' },
      ],
    },
    footer: {
      links: [],
