...
### Added [**dxScreenshot**](/modules/ui/dxScreenshot) module

Added [**dxScreenshot**](/modules/ui/dxScreenshot) module: A high-level screenshot helper that enables capturing and uploading UI screenshots via simple interactions like double-clicking, streamlining remote diagnostics.
...
For detailed API documentation, please refer to our [Fingerprint Recognition Development Overview](/docs/finger/overview).
...
For detailed information, please refer to our [UI Animation documentation](/docs/ui/animation).
...
3. **Comprehensive Documentation Support**
   New series of [Facial Recognition Development Overview](/docs/face/overview) documents.
...
Detailed API references and examples are available in the **[Official DejaOS Modules Documentation](/modules/welcome)**.
