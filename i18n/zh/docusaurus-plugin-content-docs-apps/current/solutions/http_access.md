...
基于 DejaOS 的**门禁一体机**应用：触摸屏上支持 **NFC 刷卡、PIN 密码、QR 扫码**三种通行方式；设备在提供 **HTTP API（v1）** 的同时，还内置 **Web 管理后台**，可用电脑或**手机浏览器**登录管理，适用于 **[FC6820](https://www.feocey.com/product/fc6820/)** 门禁一体机。
