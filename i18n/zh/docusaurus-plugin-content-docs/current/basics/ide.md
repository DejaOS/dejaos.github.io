...
如果您偏好终端开发、自动化脚本或 AI 辅助编程，也可以使用独立的 [DejaOS CLI](./cli.md)。CLI 无需安装 VSCode 插件，并提供安装组件、构建、同步、运行和查看日志等能力。
...
dejaOS IDE 为嵌入式应用程序开发提供一站式支持，集成了模块管理、打包部署、设备连接调试等功能。是高效开发 dejaOS 应用程序的推荐工具。
